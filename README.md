...
Vite + React 18 + TypeScript (strict) · Tailwind · TanStack Query · react-hook-form + Zod · Drizzle ORM · Turso (libSQL) · Vercel (Serverless Functions) · Vitest
