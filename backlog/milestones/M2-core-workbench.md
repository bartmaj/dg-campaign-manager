...
- [ ] [#009 Implement the polymorphic typed-edge table](../issues/009-implement-the-polymorphic-typed-edge-table.md)
- [ ] [#010 Implement the Clue entity with provenance and edges](../issues/010-implement-the-clue-entity-with-provenance-and-ed.md)
